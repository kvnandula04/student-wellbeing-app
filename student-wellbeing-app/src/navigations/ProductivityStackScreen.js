...
export default function ProductivityStackScreen() {
  return (
    <ProductivityStack.Navigator
        ...
        <ProductivityStack.Screen name="LogProductivity" component={LogProductivity} />
        <ProductivityStack.Screen name="ProductivityAnalytics" component={ProductivityAnalytics} />
    </ProductivityStack.Navigator>
  )
}
