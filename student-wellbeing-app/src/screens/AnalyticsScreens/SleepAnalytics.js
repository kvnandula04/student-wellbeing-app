...
export default function SleepAnalytics({navigation}) {
    ...
    return(
      ...
      <View style={PlaceholderStyles.container}>
        ...
        <View>
        <Text style = {styles.analyticstext}>Longest sleep day:  <Stat name={backendvalue1} /></Text>
        <Text style = {styles.analyticstext}>Today's sleep: <Stat name={backendvalue2}/></Text>
        <Text style = {styles.analyticstext}>This week's sleep score: <Stat name={backendvalue3}/></Text>
      </View>
      <Pressable
          style={styles.button}
