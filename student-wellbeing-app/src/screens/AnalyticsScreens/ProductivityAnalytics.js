...
export default function ProductivityAnalytics() {
    ...
    return(
      ...
      <View style={PlaceholderStyles.container}>
        ...
        <View>
        <Text style = {styles.analyticstext}>Most productive on:  <Stat name={backendvalue1} /></Text>
        <Text style = {styles.analyticstext}>Today's productivity: <Stat name={backendvalue2}/></Text>
        <Text style = {styles.analyticstext}>This week's productivity: <Stat name={backendvalue3}/></Text>
      </View>
      <Pressable
          style={styles.button}
